        ...
        <div className="contact-section-wrapper">
            <div className="form-container">
                ...
                <form className="contact-form">
                    ...
                    <DropDown placeData={placeData} labelText={'Your Home Town'} inputID={'source'} />
                    <DropDown placeData={placeData} labelText={'Where would you like to go?'} inputID={'destination'} />
